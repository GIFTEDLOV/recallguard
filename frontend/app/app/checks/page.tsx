...
export default function ChecksPage({ initialListingId = "" }: { initialListingId?: string }) {
  ...
  async function submit(event: FormEvent) {
    ...
    try {
      const result = await contract.requestAssessment({ listingId, recallUrl, noticeReference, recallSha256, walletAddress: wallet }, setProgress);
