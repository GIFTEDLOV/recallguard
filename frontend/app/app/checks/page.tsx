...
export default function ChecksPage({ initialListingId = "" }: { initialListingId?: string }) {
  ...
  return <div className="page-stack">
    ...
    {wallet && !isCorrectNetwork && <Notice tone="warning" title="Wrong network">Switch to GenLayer Studio-dev before requesting a check.<button className="text-button" type="button" onClick={() => void switchNetwork()} disabled={connecting}>{connecting ? "Switching..." : "Switch network"}</button></Notice>}
