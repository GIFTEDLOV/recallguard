...
export default function NewListingPage() {
  ...
  return <div className="page-stack narrow-page">
    ...
    {wallet && !isCorrectNetwork && <Notice tone="warning" title="Wrong network">Switch to GenLayer Bradbury before sending this registration.<button className="text-button" type="button" onClick={() => void switchNetwork()} disabled={connecting}>{connecting ? "Switching..." : "Switch network"}</button></Notice>}
