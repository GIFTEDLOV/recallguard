...
export default function ActivityPage() {
  ...
  return <div className="page-stack">
    <section className="page-intro"><div><div className="eyebrow">Contract ledger</div><h2>Activity</h2><p>Append order for listing registrations and recorded permissionless assessments. V2 does not invent timestamps or protocol finality that the contract does not store.</p></div></section>
