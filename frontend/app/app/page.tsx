...
export default function DashboardPage() {
  ...
  return <div className="page-stack">
    <section className="page-intro"><div><div className="eyebrow">Safety operations</div><h2>Know what should no longer be sold.</h2><p>Track product listings, run evidence-bound recall checks, and keep the resulting safety state tied to a finalized GenLayer attestation.</p></div><div className="intro-actions"><button className="button button-secondary" onClick={() => void refresh()} disabled={loading}><Icon name="refresh" size={15} />{loading ? "Refreshing" : "Refresh state"}</button><Link className="button button-primary" href="/app/listings/new"><Icon name="plus" size={16} />Register listing</Link></div></section>
